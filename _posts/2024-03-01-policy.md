...
authors:
  - name: Chatbot Arena Team
    affiliations:
      name: LMArena
---
<div style="text-align: right">Note: this policy doc is not up-to-date. Please see the latest one <a href="https://news.lmarena.ai/policy/">here</a>.</div>

## Our Mission

LMArena ([lmarena.ai](https://lmarena.ai)) is an open platform for model evaluations. Our mission is to advance AI development and understanding through live, open, and community-driven evaluations. We maintain the open evaluation platform for any user to rate LLMs via pairwise comparisons under real-world use cases and publish [leaderboard](https://lmarena.ai/?leaderboard) periodically.
