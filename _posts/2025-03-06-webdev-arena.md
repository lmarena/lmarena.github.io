...
<div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
  <img src="/assets/img/blog/webdev_arena/base-leaderboard.png" alt="Original Leaderboard" style="width: 45%; margin: 0;">
  <img src="/assets/img/blog/webdev_arena/base-leaderboard-deduplicated.png" alt="Deduplicated Leaderboard" style="width: 45%; margin: 0;">
</div>
<p style="color:gray; text-align: center; padding-top: 10px;">Figure 9. Comparison of original (left) and deduplicated (right) leaderboards.</p>
